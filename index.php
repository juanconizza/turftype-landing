  ...
  <div class="container d-flex align-items-center justify-content-between">
    <div class="logo">
      ...
      <img
              ...
              class="img-fluid w-75 beneficios"
              alt="beneficios"
            />  
    </div>
        ...
        <div class="row">
          ...
          >
            <div class="heroTitle">
              ...
              <h3>Solicitá Asesoramiento Profesional personalizado e inmediato</h3>
              </div>
      ...
      <section id="contact" class="contact d-flex justify-content-center">
        <div class="container">
          ...
          <div class="row justify-content-center mt-5" data-aos="fade-up">
            ...
            <div class="col-lg-6 d-flex flex-column align-items-center text-center mb-4">
              <img
